...
public class UserController {
    ...
    public BaseResponse<?> register(@RequestBody UserRegisterRequest request){
        ...
        userService.register(Long.valueOf(tenantId), phone, password1, password2, code);
    ...
    public BaseResponse<?> resetPass(@RequestBody ResetPasswordRequest rpRequest) {
    ...
    public BaseResponse<?> resetPhone(@RequestBody ResetPhoneRequest cpRequest){
    ...
    public BaseResponse<?> getUsers(){
        String tenantId = TenantContext.getTenantId();
        List<UserDTO> users = userQueryService.getUsers(Long.valueOf(tenantId));
